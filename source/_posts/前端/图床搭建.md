...
国内推荐七牛云，七牛云有免费的10G存储空间，每月有10G的免费流量，足够个人使用了
七牛云地址：https://s.qiniu.com/E3eqyu
...
#### 七牛云
七牛云使用s3兼容的存储桶，不需要绑定域名，只是会没有CDN加速

在后台添加渠道，选择七牛云
Endpoint填写空间概览里的系统域名

存储桶名称填写空间名

存储桶区域根据文档的区域选择 https://developer.qiniu.com/kodo/4088/s3-access-domainname
填写区域简称 Region ID，如 ap-southeast-1 对应新加坡

访问密钥 ID和
机密访问密钥
这两个在头像里的密钥管理里，创建一个即可
AccessKey/SecretKey对应访问密钥 ID/机密访问密钥
